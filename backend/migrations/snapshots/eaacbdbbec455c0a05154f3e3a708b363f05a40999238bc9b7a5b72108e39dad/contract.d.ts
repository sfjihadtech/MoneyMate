...
export type StorageHash =
  StorageHashBase<'eaacbdbbec455c0a05154f3e3a708b363f05a40999238bc9b7a5b72108e39dad'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Transaction: {
      ...
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly transferGroupId: CodecTypes['pg/text@1']['output'] | null;
    };
    readonly TrialDevice: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly userId: CodecTypes['pg/int4@1']['output'];
      readonly deviceHash: CodecTypes['pg/text@1']['output'];
      readonly trialStartedAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    readonly User: {
      readonly id: CodecTypes['pg/int4@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Transaction: {
      ...
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly transferGroupId: CodecTypes['pg/text@1']['input'] | null;
    };
    readonly TrialDevice: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      readonly userId: CodecTypes['pg/int4@1']['input'];
      readonly deviceHash: CodecTypes['pg/text@1']['input'];
      readonly trialStartedAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly User: {
      readonly id: CodecTypes['pg/int4@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly trialDevice: {
              ...
              uniques: readonly [
                { readonly columns: readonly ['userId'] },
                { readonly columns: readonly ['deviceHash'] },
              ];
              indexes: readonly [];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'trialDevice';
                    readonly columns: readonly ['userId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
          ...
          readonly Transaction: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
                readonly transferGroupId: { readonly column: 'transferGroupId' };
              };
            };
          };
          readonly TrialDevice: {
            ...
            readonly storage: {
              readonly table: 'trialDevice';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly userId: { readonly column: 'userId' };
                readonly deviceHash: { readonly column: 'deviceHash' };
                readonly trialStartedAt: { readonly column: 'trialStartedAt' };
                readonly createdAt: { readonly column: 'createdAt' };
              };
            };
          };
